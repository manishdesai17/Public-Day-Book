            ...
            <div class="row d-flex justify-content-center" style="background-color: white;">
                ...
                <div class="col-md-6 s" style="margin-top: 1rem;">
                    <div class="container">
                        ...
                        <div class="content">
                            <form action="AdminLoginServlet" onsubmit="return match()" method="post" class="pb-4" id="reg-form" onsubmit="return validation()">
                                <div class="user-details">
                                </div>
                                <div class="input-box">
                                    <span class="details">admin name</span>
                                    <input type="text" class="mb-2" id="email" name="Adminname" placeholder="Enter username"
                                           required />
                                </div>
                                <div class="input-box">
